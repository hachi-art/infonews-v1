// ============================================================
// services/africanewsRss.js — Africanews RSS
// Chaîne panafricaine — couverture Afrique subsaharienne
// ============================================================
const Parser = require('rss-parser');
const parser = new Parser({ timeout: 10000, headers: { 'User-Agent': 'infonews.day/2.0' } });

const FEEDS = [
  { url: 'https://www.africanews.com/feed/', category: 'monde' },
];
...
async function fetchAfricanewsNews(limit = 10) {
...
module.exports = { fetchAfricanewsNews };
