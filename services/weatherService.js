...
const CITIES = [
  ...
  { name: 'Bruxelles',    lat: 50.8503,  lon: 4.3517,    flag: '🇧🇪' },
  { name: 'Lisbonne',     lat: 38.7169,  lon: -9.1395,   flag: '🇵🇹' },
  { name: 'Vienne',       lat: 48.2082,  lon: 16.3738,   flag: '🇦🇹' },
  { name: 'Zurich',       lat: 47.3769,  lon: 8.5417,    flag: '🇨🇭' },
  { name: 'Stockholm',    lat: 59.3293,  lon: 18.0686,   flag: '🇸🇪' },
  { name: 'Oslo',         lat: 59.9139,  lon: 10.7522,   flag: '🇳🇴' },
  { name: 'Helsinki',     lat: 60.1699,  lon: 24.9384,   flag: '🇫🇮' },
  { name: 'Prague',       lat: 50.0755,  lon: 14.4378,   flag: '🇨🇿' },
  { name: 'Varsovie',     lat: 52.2297,  lon: 21.0122,   flag: '🇵🇱' },
  { name: 'Budapest',     lat: 47.4979,  lon: 19.0402,   flag: '🇭🇺' },
  { name: 'Athènes',      lat: 37.9838,  lon: 23.7275,   flag: '🇬🇷' },
  { name: 'Istanbul',     lat: 41.0082,  lon: 28.9784,   flag: '🇹🇷' },
  { name: 'Moscou',       lat: 55.7558,  lon: 37.6173,   flag: '🇷🇺' },
  { name: 'Kiev',         lat: 50.4501,  lon: 30.5234,   flag: '🇺🇦' },
  // ── Amériques ────────────────────────────────────
  { name: 'New York',     lat: 40.7128,  lon: -74.0060,  flag: '🇺🇸' },
  { name: 'Los Angeles',  lat: 34.0522,  lon: -118.2437, flag: '🇺🇸' },
  { name: 'Chicago',      lat: 41.8781,  lon: -87.6298,  flag: '🇺🇸' },
  { name: 'Miami',        lat: 25.7617,  lon: -80.1918,  flag: '🇺🇸' },
  { name: 'Montréal',     lat: 45.5017,  lon: -73.5673,  flag: '🇨🇦' },
  { name: 'Vancouver',    lat: 49.2827,  lon: -123.1207, flag: '🇨🇦' },
  ...
  { name: 'Bogotá',       lat: 4.7110,   lon: -74.0721,  flag: '🇨🇴' },
  { name: 'Lima',         lat: -12.0464, lon: -77.0428,  flag: '🇵🇪' },
  { name: 'Santiago',     lat: -33.4489, lon: -70.6693,  flag: '🇨🇱' },
  // ── Asie / Océanie ───────────────────────────────
  ...
  { name: 'Taipei',       lat: 25.0330,  lon: 121.5654,  flag: '🇹🇼' },
  { name: 'Singapour',    lat: 1.3521,   lon: 103.8198,  flag: '🇸🇬' },
  { name: 'Bangkok',      lat: 13.7563,  lon: 100.5018,  flag: '🇹🇭' },
  { name: 'Jakarta',      lat: -6.2088,  lon: 106.8456,  flag: '🇮🇩' },
  { name: 'Manila',       lat: 14.5995,  lon: 120.9842,  flag: '🇵🇭' },
  { name: 'Mumbai',       lat: 19.0760,  lon: 72.8777,   flag: '🇮🇳' },
  { name: 'Delhi',        lat: 28.6139,  lon: 77.2090,   flag: '🇮🇳' },
  { name: 'Karachi',      lat: 24.8607,  lon: 67.0011,   flag: '🇵🇰' },
  { name: 'Dacca',        lat: 23.8103,  lon: 90.4125,   flag: '🇧🇩' },
  { name: 'Sydney',       lat: -33.8688, lon: 151.2093,  flag: '🇦🇺' },
  { name: 'Melbourne',    lat: -37.8136, lon: 144.9631,  flag: '🇦🇺' },
  { name: 'Auckland',     lat: -36.8485, lon: 174.7633,  flag: '🇳🇿' },
  // ── Moyen-Orient ─────────────────────────────────
  { name: 'Dubai',        lat: 25.2048,  lon: 55.2708,   flag: '🇦🇪' },
  { name: 'Riyad',        lat: 24.6877,  lon: 46.7219,   flag: '🇸🇦' },
  { name: 'Tel Aviv',     lat: 32.0853,  lon: 34.7818,   flag: '🇮🇱' },
  { name: 'Téhéran',      lat: 35.6892,  lon: 51.3890,   flag: '🇮🇷' },
  { name: 'Bagdad',       lat: 33.3152,  lon: 44.3661,   flag: '🇮🇶' },
  { name: 'Beyrouth',     lat: 33.8938,  lon: 35.5018,   flag: '🇱🇧' },
  { name: 'Doha',         lat: 25.2854,  lon: 51.5310,   flag: '🇶🇦' },
  { name: 'Koweït',       lat: 29.3759,  lon: 47.9774,   flag: '🇰🇼' },
  // ── Afrique ──────────────────────────────────────
  { name: 'Le Caire',     lat: 30.0444,  lon: 31.2357,   flag: '🇪🇬' },
  { name: 'Lagos',        lat: 6.5244,   lon: 3.3792,    flag: '🇳🇬' },
  { name: 'Kinshasa',     lat: -4.3217,  lon: 15.3222,   flag: '🇨🇩' },
  { name: 'Nairobi',      lat: -1.2921,  lon: 36.8219,   flag: '🇰🇪' },
  { name: 'Johannesburg', lat: -26.2041, lon: 28.0473,   flag: '🇿🇦' },
  { name: 'Le Cap',       lat: -33.9249, lon: 18.4241,   flag: '🇿🇦' },
  { name: 'Casablanca',   lat: 33.5731,  lon: -7.5898,   flag: '🇲🇦' },
  { name: 'Tunis',        lat: 36.8065,  lon: 10.1815,   flag: '🇹🇳' },
  { name: 'Alger',        lat: 36.7538,  lon: 3.0588,    flag: '🇩🇿' },
  { name: 'Accra',        lat: 5.6037,   lon: -0.1870,   flag: '🇬🇭' },
  { name: 'Addis-Abeba',  lat: 9.0320,   lon: 38.7469,   flag: '🇪🇹' },
  { name: 'Antananarivo', lat: -18.9137, lon: 47.5361,   flag: '🇲🇬' },
  { name: 'Dakar',        lat: 14.7167,  lon: -17.4677,  flag: '🇸🇳' },
  { name: 'Abidjan',      lat: 5.3544,   lon: -4.0020,   flag: '🇨🇮' },
];
